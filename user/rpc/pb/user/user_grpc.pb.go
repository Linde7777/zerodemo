...
func (c *userClient) GetUser(ctx context.Context, in *ReqGetUser, opts ...grpc.CallOption) (*RespGetUser, error) {
	out := new(RespGetUser)
...
func (UnimplementedUserServer) GetUser(context.Context, *ReqGetUser) (*RespGetUser, error) {
...
func _User_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUser(ctx, req.(*ReqGetUser))
	}
